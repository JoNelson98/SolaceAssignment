...
const generateRandomAdvocate = () => ({
    ...
    phoneNumber: BigInt(Math.floor(Math.random() * 9000000000) + 1000000000),
})

const randomAdvocates = Array.from({ length: 1000 }, generateRandomAdvocate)

const advocateData = [...originalAdvocates, ...randomAdvocates]
